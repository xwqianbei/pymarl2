...
## Method
- llm role to train the role selector
- llm trajector description to train the trajector encoder $h_i$
![Framework](./img/LLMROLE.drawio.png "Magic Gardens")
...
text_embedding_model_path: "/root/pymarl2/model/bge-base-en-v1___5"
```

Set the llm api and fix the api-url in `src/utils/api.py`
```
# src/config/algs/llm_qmix.yaml
api_type: "qwen"
